...
class AutomationTab(QWidget):
    ...
    def _build_action_editor(self) -> QWidget:
        ...
        self.action_chat_id.setPlaceholderText(tr("Receiver ID"))
        ...
        self.action_message_template.setMinimumHeight(44)
        self.action_message_help_btn = QPushButton("?")
        self.action_message_help_btn.setObjectName("AutomationHeaderIconButton")
        self.action_message_help_btn.setFixedSize(24, 24)
        self.action_message_help_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        ...
        form.addRow(tr("Receiver ID"), self.action_chat_id)
