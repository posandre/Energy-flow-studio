                    ...
                    steps.append(
                        AutomationRunStep(
                            ...
                            payload={
                                ...
                                "bot_token_ref": str(params.get("bot_token_ref", "")).strip(),
                                "chat_id": str(params.get("chat_id", "")).strip(),
                                "messenger": str(params.get("messenger", "telegram")).strip().lower() or "telegram",
                                "message_template": str(params.get("message_template", "")).strip(),
