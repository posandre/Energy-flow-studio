...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "uk": {
        ...
        "Import rule from JSON": "Імпорт правила з JSON",
        "Export rule to JSON": "Експорт правила в JSON",
        "JSON Files (*.json)": "Файли JSON (*.json)",
        "Import error": "Помилка імпорту",
        "Export error": "Помилка експорту",
        "Failed to read JSON file:\n{error}": "Не вдалося прочитати JSON-файл:\n{error}",
        "Failed to export rule JSON:\n{error}": "Не вдалося експортувати правило в JSON:\n{error}",
        "Invalid automation rule format:\n{error}": "Некоректний формат правила автоматизації:\n{error}",
        "No rules found in JSON file.": "У JSON-файлі не знайдено правил.",
        "Import": "Імпорт",
        "Duplicate": "Дублювати",
        ...
        "Measurement": "Вимір",
        "Schedule": "Розклад",
        "Snapshot update": "Оновлення снапшота",
        "Manual": "Вручну",
        "Type": "Тип",
        "Operator": "Оператор",
        "Delay": "Затримка",
        ...
        "Failed to send test message: {details}": "Не вдалося надіслати тестове повідомлення: {details}",
        "Message action requires bot token and chat ID.": "Для дії повідомлення потрібні токен бота і Chat ID.",
        "Action: {messenger} message ({chat_id})": "Дія: повідомлення {messenger} ({chat_id})",
        "{messenger} ({chat_id})": "{messenger} ({chat_id})",
        "Telegram message sent to chat {chat_id} (attempt {attempt}/{max_attempts}).": "Повідомлення Telegram надіслано в чат {chat_id} (спроба {attempt}/{max_attempts}).",
        "Viber message sent to chat {chat_id} (attempt {attempt}/{max_attempts}).": "Повідомлення Viber надіслано в чат {chat_id} (спроба {attempt}/{max_attempts}).",
        "Viber API returned a non-JSON response.": "API Viber повернуло відповідь не у форматі JSON.",
        "Receiver ID is empty.": "Receiver ID порожній.",
        ...
        "Action: {device} - Inverter settings ({count})": "Дія: {device} - Налаштування інвертора ({count})",
        "Action: {device} - {state}": "Дія: {device} - {state}",
        "On": "Увімк",
        "Off": "Вимк",
        ...
        "Trigger: Snapshot update": "Тригер: оновлення снапшота",
        ...
        "action is ready (forced run)": "дія готова (примусовий запуск)",
        "state has not changed since previous run": "стан не змінився від попереднього запуску",
        "{device} - Inverter settings ({count})": "{device} - Налаштування інвертора ({count})",
        "{device} - {state}": "{device} - {state}",
        "Block": "Блок",
        "Delete block": "Видалити блок",
        'Are you sure you want to delete block "{name}"?': 'Ви впевнені, що хочете видалити блок "{name}"?',
        "Fires when a new data snapshot is received.": "Спрацьовує, коли надходить новий снапшот даних.",
        "ACTIVE": "АКТИВНЕ",
        "DRAFT": "ЧЕРНЕТКА",
        "ON": "УВІМК",
        "OFF": "ВИМК",
        ...
        "Manual run requested by user.": "Користувач запустив правило вручну.",
        "══════════ Rule: {name} ({rule_id}) ══════════": "══════════ Правило: {name} ({rule_id}) ══════════",
        "Simulation completed: conditions {status}.": "Симуляцію завершено: умови {status}.",
        "────────────────── Simulation Start ──────────────────": "────────────────── Початок симуляції ──────────────────",
        'Rule: "{name}" | Measurements for check: {count}': 'Правило: "{name}" | Даних для перевірки: {count}',
        "─────────────────── Simulation End ───────────────────": "────────────────── Завершення симуляції ─────────────────",
        "──────────────────── Run Start ────────────────────": "────────────────── Початок виконання ──────────────────",
        'Rule: "{name}" | Measurements for check: {count} | Force start: {force_start}': 'Правило: "{name}" | Даних для перевірки: {count} | Примусовий старт: {force_start}',
        "yes": "так",
        "no": "ні",
        "Execution plan: total={total} action_steps={actions} delay_steps={delays}": "План виконання: кроків {total} (дій: {actions}, затримок: {delays})",
        "Delay before next step: {seconds} sec": "Затримка перед наступним кроком: {seconds} с",
        "Action: {device} - {state} (attempt {attempt}/{max_attempts}).": "Дія: {device} - {state} (спроба {attempt}/{max_attempts}).",
        "───────────────────── Run End ─────────────────────": "────────────────── Завершення виконання ─────────────────",
        "Run summary: success={ok} fail={fail} skipped={skipped} executed_actions={actions}": "Підсумок: успішно {ok}, помилок {fail}, пропущено {skipped}, виконаних дій {actions}",
        "[Step {index}/{total}] {node_type}": "[Крок {index}/{total}] {node_type}",
        "done": "виконано",
        ...
        "{prefix}: Gate evaluation -> {status}. Inputs: {inputs}, true: {true_count}, false: {false_count}. Internal: {internal_inputs}, true: {internal_true}, false: {internal_false}.": "{prefix}: Логіка блоку -> {status}. Входів: {inputs}, true: {true_count}, false: {false_count}. Внутрішні умови: {internal_inputs}, true: {internal_true}, false: {internal_false}.",
        '{prefix}: Metric "{metric}" is missing in current measurements.': '{prefix}: Параметр "{metric}" відсутній у поточних даних.',
        "{prefix}: {status}. Details: {details}": "{prefix}: {status}. Деталі: {details}",
        "start node ready": "початковий блок готовий",
        "end reached": "досягнуто кінцевий блок",
        "action is ready": "дія готова до виконання",
        "delay is ready": "затримка готова",
        "blocked by upstream node": "попередній блок не дозволяє продовження",
        "forced start": "примусовий старт",
